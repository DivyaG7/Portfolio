  ...
  return (
    <div id="Projects" className='p-20 flex flex-col items-center justify-center '>
        ...
        <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 justify-around gap-10'>
            <a href='https://dflorist.netlify.app/'><img data-aos="fade-up" height={250} width={250} className='text-[26px] flex items-center justify-center  rounded-3xl p-1 border-2 border-fuchsia-800 b_glow' src={img1} alt='' /></a>
            ...
            <a href='/'><img data-aos="fade-down" height={250} width={250} className='text-[26px] flex items-center justify-center  rounded-3xl p-1 border-2 border-fuchsia-800 b_glow' src={img4} alt='' /></a>
        </div>
    </div>
  )
}
